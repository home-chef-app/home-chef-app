...
locals {
  id = "${var.resource_prefix}-${var.env}"
}
...
resource "aws_cognito_user_pool" "home_chef_user_pool" {
...
resource "aws_cognito_user_pool_client" "home_chef_user_pool_client" {
  name = "${local.id}-client"

  user_pool_id = aws_cognito_user_pool.home_chef_user_pool.id
